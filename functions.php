...
function theme_enqueue_styles()
{
    ...
    wp_enqueue_style('df-rest-fonts', 'https://fonts.googleapis.com/css?family=Cabin|Herr+Von+Muellerhoff|Source+Sans+Pro');
}
...
if (is_admin()) {
    ...
    $plugins = [
        ...
        [
            ...
            'slug'     => 'events-calendar-pro.php/events-calendar-pro.php.php',
            'url'   => 'https://theeventscalendar.com/events-calendar-pro/',
            'trial' => false,
        ],
    ];
...
{
    $default_text .= '<div class="ocdi__intro-text">One click import of demo data, Divi theme customizer settings and WordPress widgets for the <b>Restaurant Events Child Theme</b></div>';
